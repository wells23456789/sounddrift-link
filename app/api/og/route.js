// app/api/og/route.js
// FIX: importar desde 'next/og' (no '@vercel/og') y quitar export runtime='edge'.
// Node.js runtime es más estable para hacer fetch externo a iTunes antes de renderizar.

import { ImageResponse } from 'next/og';

// SIN export const runtime = 'edge' → usa Node.js runtime por defecto
// Esto resuelve la página en blanco que ocurre en Edge con await fetch()
