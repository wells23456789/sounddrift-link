...
export default function SharePage({ searchParams }) {
  ...
  useEffect(() => {
    if (artwork) { setDisplayArtwork(artwork); return; }
    ...
    fetch(`https://itunes.apple.com/search?term=${q}&entity=song&limit=3&media=music`)
      ...
      .then(data => {
        ...
        for (const r of results) {
          const img = r?.artworkUrl100;
          if (img) { setDisplayArtwork(img.replace('100x100bb', '600x600bb')); return; }
        }
      })
      .catch(() => {});
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        /* ── Fondo: gradiente morado como Spotify ── */
        .page {
          min-height: 100vh;
          display: flex;
        ...
        /* Brillo difuso arriba izquierda como Spotify */
        .page::before {
          content: '';
          position: absolute;
          width: 900px; height: 600px;
          top: -200px; left: -200px;
          background: radial-gradient(ellipse, rgba(180,60,255,0.45) 0%, transparent 65%);
          filter: blur(40px);
          pointer-events: none;
        }
        ...
        /* Botones lado a lado como Spotify */
        .btn-row {
          display: flex;
          align-items: center;
          gap: 12px;
        ...
        .hero-right {
          flex-shrink: 0;
          opacity: 0;
          animation: scaleIn 0.6s cubic-bezier(0.34,1.56,0.64,1) 0.25s forwards;
        }
        ...
        @media (max-width: 600px) {
          ...
          .song-title { font-size: clamp(24px, 7vw, 36px); }
        ...
        <div className="hero">
          ...
          <div className="hero-left">
            ...
            <p className="footer-note">
              Escucha tu música sin límites, sin anuncios y sin conexión.
              Descarga SoundDrift gratis y disfruta esta canción ahora.
            </p>
          </div>
